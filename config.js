var config = {
    ...
    subtitle: 'Exploring the Relationship Between Race, Gender, and Economic Exchange',
    ...
    chapters: [
        ...
        {  id: 'Conclusion',
            ...
            title: 'Conclusion',
            image: 'https://raw.githubusercontent.com/doriaguadagnoli/all_map_data/main/Screenshot_collage_.jpg',
            description: 'These specific economic exchanges in <em>The Color Purple</em>, <em>As I Lay Dying</em>, and <em>Their Eyes Were Watching God</em> expose the overlapping and intersecting structures that influence each of these southern women/’s lives. Power, gender, and race all play an undeniably large role in their economic ventures. For characters like Janie and Celie, many of their transactions relied upon the connections of others or an inheritance of some kind. They were, however, able to be mobile and used that to their advantage. While Dewey Dell/’s race is not an obstacle for her, she is still lower class, a minor, and predominantly stationary, which imposes many of the same issues Celie experiences. Although the map was able to display the concrete exchanges, I would argue that there were many emotional or intangible exchanges in each of these three novels. The inclusion of these intangible exchanges would have provided some more insight into the character\’s lives, struggle, and them themselves. Ultimately, these exchanges speak to the different, inherent or gained, means required for access to the world and underscore the fight for autonomy in a society that consistently attempts to combat it.',
            location: {
                center: [-89.48166198038979, 34.28439371230351], 
                zoom: 4,
                pitch: 30,
